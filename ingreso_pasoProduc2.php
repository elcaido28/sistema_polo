...
<div class="content_todo">
  <center>
    <h1 class="tituloF">REGISTRO DE LA PRODUCCIÓN - SELECCIONADO</h1>
    <hr><br>
  <form class="formu" action="guardar_pasoProduc2.php?id=<?php echo $id_produc0; ?>" method="post">
    ...
    <label for="" class="etiq">Mermas en Kg</label>
    <input type="text" class="cajatext" name="merma" placeholder="Total Merma: 100" value="" onkeypress="return solonumeros(event)" onpaste="return false" required>
  ...
  <table class="tabla">
      ...
      <tr>
        ...
        $consulta=mysqli_query($con,"SELECT * from regis_produccion2 where fecha1 like '%".$busqtipo."%' and id_regis_produccion='$id_produc0' ORDER BY fecha1 DESC");
        ...
        ?>
              ...
              <td><a href="modificar_pasoProduc2.php?id=<?php echo $row['id_regis_produccion2'];?>" class="modificar"><i class="far fa-edit">CAMBIAR</i></a></td>
      </tr>
        <?php
              }
        ?>
