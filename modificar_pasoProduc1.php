...
$id_produc0=$_SESSION['ID'];
 ...
 <?php
    $id=$_REQUEST['id'];
 include('conexion.php');
 $result= mysqli_query($con,"SELECT * from regis_produccion1 where id_regis_produccion1='$id'");
...
<div class="content_todo">
  ...
  <hr><br><br>
  <form class="formu" action="modificarPro_pasoProduc1.php?id=<?php echo $id; ?>" method="post">
    ...
    <div class="C_btn">
      ...
      <a href="ingreso_pasoProduc1.php" class="cancelar">CANCELAR</a>
    </div>
  </form>
  <br>
