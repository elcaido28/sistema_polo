...
<div class="content_todo">
  <center>
    <h1 class="tituloF">REGISTRO DE LA PRODUCCIÓN - DISTRIBUCIÓN</h1>
    <hr><br>
  <form class="formu" action="guardar_pasoProduc4.php?id=<?php echo $id_produc0; ?>" method="post">
  ...
  <table class="tabla">
      ...
      <tr>
        ...
        $consulta=mysqli_query($con,"SELECT * from regis_produccion4 where fecha1 like '%".$busqtipo."%' and id_regis_produccion='$id_produc0' ORDER BY fecha1 DESC");
        ...
        ?>
              ...
              <td><a href="modificar_pasoProduc4.php?id=<?php echo $row['id_regis_produccion4'];?>" class="modificar"><i class="far fa-edit">CAMBIAR</i></a></td>
      </tr>
        <?php
              }
        ?>
